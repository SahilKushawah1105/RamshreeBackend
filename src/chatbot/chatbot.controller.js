...
var chatbot_service_1 = require("./chatbot.service");
...
var ChatbotController = /** @class */ (function () {
    ...
    ChatbotController.prototype.query = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.chatbotService.getAIResponse(body.message, body.history || [])];
            });
        });
    };
    __decorate([
    ...
    ], ChatbotController.prototype, "query");
