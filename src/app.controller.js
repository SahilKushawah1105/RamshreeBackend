...
var AppController = /** @class */ (function () {
    function AppController(appService, productsService, settingsService, usersService) {
    ...
    AppController.prototype.getStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, products, settings, users;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), products = _a[0], settings = _a[1], users = _a[2];
                        return [2 /*return*/, {
    ...
    ], AppController.prototype, "getStats");
